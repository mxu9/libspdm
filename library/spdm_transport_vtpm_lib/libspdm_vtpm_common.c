 ...
 * @retval RETURN_INVALID_PARAMETER     The message is NULL or the message_size is zero.
 **/
libspdm_return_t libspdm_transport_vtpm_encode_message(
    void *spdm_context,
    const uint32_t *session_id,
    bool is_app_message,
    bool is_requester,
    ...
    void **transport_message)
{
    ...
    spdm_secured_message_callbacks.get_sequence_number =
        libspdm_vtpm_get_sequence_number;
    spdm_secured_message_callbacks.get_max_random_number_count =
        libspdm_vtpm_get_max_random_number_count;
    ...
    if (session_id != NULL) {
        ...
        status = libspdm_vtpm_encode_app_message(is_app_message,
                                                message_size,
                                                message,
                                                &app_message_size,
                                                &app_message);
        ...
        transport_header_size = libspdm_transport_vtpm_get_header_size(spdm_context);
        ...
        status = libspdm_vtpm_encode_message(session_id,
                                            secured_message_size,
                                            secured_message,
        ...
        status = libspdm_vtpm_encode_message(NULL,
                                             message_size,
                                             message,
                                             transport_message_size,
                                             transport_message);
 ...
 **/
libspdm_return_t libspdm_transport_vtpm_decode_message(
    void *spdm_context,
    uint32_t **session_id,
    bool *is_app_message,
    bool is_requester,
    ...
    void **message)
{
    ...
    status = libspdm_vtpm_decode_message(&secured_message_session_id,
                                        transport_message_size,
                                        transport_message,
                                        &secured_message_size,
    ...
    if (secured_message_session_id == NULL) {
        ...
        *session_id = secured_message_session_id;
        ...
        status = libspdm_vtpm_decode_app_message(is_app_message,
                                                app_message_size,
                                                app_message,
                                                message_size,
                                                message);
        if (LIBSPDM_STATUS_IS_ERROR(status)) {
            LIBSPDM_DEBUG((LIBSPDM_DEBUG_ERROR,
                            "transport_decode_message - unknow vtpm_app_message_header. (%x)\n",
                            *app_message));
        }
