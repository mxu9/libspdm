...
#ifndef SPDM_VTPM_TRANSPORT_LIB_H
#define SPDM_VTPM_TRANSPORT_LIB_H
 ...
 * Take VTPM as example: APP message == MCTP header (MCTP_MESSAGE_TYPE_SPDM) + SPDM message
 *
 ...
 **/
uint8_t libspdm_vtpm_get_sequence_number(
...
#endif /* SPDM_VTPM_TRANSPORT_LIB_H */
